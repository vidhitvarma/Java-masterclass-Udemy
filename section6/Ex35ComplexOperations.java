...
public class Ex35ComplexOperations {
	private double real;
	private double imaginary;

	public Ex35ComplexOperations(double real, double imaginary) {
	...
	public void add(Ex35ComplexOperations complexNumber) {
	...
	public void subtract(Ex35ComplexOperations complexNumber) {
		this.real -= complexNumber.getReal();
		this.imaginary -= complexNumber.getImaginary();
	}
 ...
 * 
 * Method named getReal without any parameters, it needs to return the value of
 * real field.
 * 
 ...
 * 
 * Method named subtract with one parameter of type ComplexNumber. It needs to
