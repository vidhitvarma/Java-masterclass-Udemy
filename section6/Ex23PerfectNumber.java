 ...
 * proper positive divisors. Proper positive divisors are positive integers that
 * fully divide the perfect number without leaving a remainder and exclude the
 * perfect number itself. For example, take the number 6: Its proper divisors
 * are 1, 2, and 3 (since 6 is the value of the perfect number, it is excluded),
